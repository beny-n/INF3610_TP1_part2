...
static KAL_LOCK_HANDLE lock;


void UCOS_PrintfInit()
{
	KAL_ERR kal_err;

	lock = KAL_LockCreate("Printf Lock", DEF_NULL, &kal_err);
}
...
void UCOS_Printf( const char *ctrl1, ...)
{
    ...
    KAL_LockAcquire(lock, 0u, 0u, &kal_err);
