...
typedef    signed  long        CPU_INT64S;                      /* 64-bit   signed integer                              */
...
#define  CPU_MB()       __asm__ __volatile__ ("dsb sy" : : : "memory")
#define  CPU_RMB()      __asm__ __volatile__ ("dsb sy" : : : "memory")
#define  CPU_WMB()      __asm__ __volatile__ ("dsb sy" : : : "memory")

/*
*********************************************************************************************************
*                                          CP15 ACCESSORS
*
* Note(s) : (1) (a) Read and Write CP15 registers using the architecturally defined name.
*
*********************************************************************************************************
*/
