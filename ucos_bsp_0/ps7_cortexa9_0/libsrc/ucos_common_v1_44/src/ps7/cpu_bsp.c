...
{
    ARM_GTMR_REG_GTCR = 0x01u;                                  /* Enable the global timer at maximum speed.            */

    CPU_TS_TmrFreqSet(XPAR_CPU_CORTEXA9_0_CPU_CLK_FREQ_HZ / 2);
}
#endif
...
CPU_INT64U  CPU_TS32_to_uSec (CPU_TS32  ts_cnts)
{
    ...
    res = (CPU_INT32U)(ts_cnts / (XPAR_CPU_CORTEXA9_0_CPU_CLK_FREQ_HZ / 2));
...
CPU_INT64U  CPU_TS64_to_uSec (CPU_TS64  ts_cnts)
{
    ...
    res = ts_cnts / (XPAR_CPU_CORTEXA9_0_CPU_CLK_FREQ_HZ / 2);
