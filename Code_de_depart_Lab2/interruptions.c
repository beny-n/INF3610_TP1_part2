...
void initialize_timer()
{
	...
	// Options: up-count + auto-reload (pour repartir de 0 après reset), pas d'INT ici
	...
	// Reset value = 0 sur les deux moitiés (utile au tout premier Reset)
	...
	XTmrCtr_Start(&timer_dev, 0);   // on démarre via timer_0
